...
Matrix4.prototype = {
  ...
  multiplyVector: function(v) {
    ...
    let x = tmp.set(e[0], e[1], e[2], e[3]).dot(v);
    let y = tmp.set(e[4], e[5], e[6], e[7]).dot(v);
    let z = tmp.set(e[8], e[9], e[10], e[11]).dot(v);
    let w = tmp.set(e[12], e[13], e[14], e[15]).dot(v);
    result.set(x,y,z,w);
		return result;
  },
  ...
  makeRotationZ: function(degrees) {
	...
	makePerspective: function(fovy, aspect, near, far) {
		...
		let fovyRads = fovy * 2 * Math.PI / 360;
