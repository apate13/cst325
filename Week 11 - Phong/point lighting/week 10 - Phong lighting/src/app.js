...
let lightPosition = new Vector4(4, 1.5, 0, 1);
...
var loadedAssets = {
    ...
    lightSphereTextVS: null, lightSphereTextFS: null,
    sphereJSON: null,
    barrelJSON: null,
    barrelImage: null,
    marbleImage: null,
...
function loadAssets(onLoadedCB) {
    ...
    Promise.all(filePromises).then(function(values) {
        ...
        loadedAssets.lightSphereTextVS = values[2];
        loadedAssets.lightSphereTextFS = values[3];
...
function createScene() {
    ...
    translation.makeTranslation(-5, 2, -5);
...
function updateAndRender() {
    ...
    // make the light orbit the sphere
