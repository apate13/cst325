...
function updateAndRender() {
    ...
    lightDirection = lightRotationHorizontal.makeRotationY(45 * time.deltaTime * cameraYaw).multiplyVector(lightDirection);
    lightDirection = lightRotationVertical.makeRotationX(45 * time.deltaTime * cameraPitch).multiplyVector(lightDirection);
