...
function updateAndRender() {
    ...
    // 2do #1 - Set up a camera that points in the direction of the light at a
    ...
    // 2do #2 - set up the view volume boundaries
    shadowProjectionMatrix.makeOrthographic( -13, 13, 13, -13, 1.0, 20);
